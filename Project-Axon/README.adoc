...
=== 1. Linux Server Setup for running Dummy Data Generator App

Ensure you have access to any running **Linux server** (e.g., CentOS, RHEL, Ubuntu) for hosting the dummy data generator application.
...
=== 5. Update the Parameter Contexts in NiFi Flow
...
==== 6: Start the `Project-Axon` NiFi Flow
...
=== 10. Accessing DataViz as Individual Users
...
+
image::images/assign_roles.png[Assign roles, width=450, height=250]
